...
TEST(Matrix_multiplication, can_multiply_matrices) {
    ...
    ASSERT_NO_THROW(getParallelTBBMatrixMultiplication(mat, mat1, &res, 6));
}
...
TEST(Matrix_multiplication, can_multiply_matrices_correct) {
    ...
    getParallelTBBMatrixMultiplication(mat, mat1, &res, 4);
...
TEST(Matrix_multiplication, can_multiply_same_as_usial_matrix) {
    ...
    getParallelTBBMatrixMultiplication(mat1, mat2, &mat3, 4);
